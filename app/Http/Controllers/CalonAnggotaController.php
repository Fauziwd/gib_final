...
class CalonAnggotaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $verifikasiCalonAnggota = VerifikasiCalonAnggota::pluck('calon_anggota_id');
    
        return view('sistem_anggota.calon-anggota.index', compact('calonAnggota', 'verifikasiCalonAnggota'));
    }
