...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,300;0,400;0,500;1,300;1,500&display=swap" rel="stylesheet">
            ...
            <ul class="space-y-2 font-medium">
                <li class="mb-4">
                    <a href="/home"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="#0E2954" class="bi bi-speedometer2"
                            viewBox="0 0 16 16">
                            <path
                ...
                <li>
                    <button type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="#0E2954" class="bi bi-person-vcard"
                            viewBox="0 0 16 16">
                            <path
                        ...
                        <svg class="w-6 h-6 text-gray-50 hover:text-gray-900 transition-colors duration-300"
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="/calon-anggota"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">Calon
                                Anggota</a>
                        </li>
                        <li>
                            <a href="/verifikasi-calon-anggota"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">Verifikasi
                                Calon Anggota</a>
                        </li>
                        <li>
                            <a href="/anggota"
                ...
                <li>
                    <button type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="#0E2954"
                ...
                <li>
                    <button type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="#0E2954" class="bi bi-bank2"
                            viewBox="0 0 16 16">
                            <path
                    ...
                    <ul id="dropdown-example-calon-mitra" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="/pondok"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">Daftar
                                Mitra</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul id="dropdown-example-daftar-trip" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="/trip-penyaluran-dana"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">Trip
                                Distribusi Beras</a>
                        </li>
                        <li>
                            <a href="/stok"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">Beras
                                Masuk</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul id="dropdown-example-daftar-account" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/peran"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">Peran</a>
                        </li>
                        <li>
                            <a href="/user"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">User</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul id="dropdown-example-opsi" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700 hover:text-red-500"
                                href="{{ route('logout') }}"
