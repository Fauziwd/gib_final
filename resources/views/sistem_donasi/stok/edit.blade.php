  ...
  <div class="flex justify-center items-center">
    <div class="bg-gradient-to-r from-blue-500 to-indigo-500 mb-10 shadow-2xl rounded-lg px-10 py-8 w-1/2">
      ...
      <form action="{{ route('stok.update', $stok->id) }}" method="POST">
        ...
        <div class="mb-4">
          <label for="dana_keluar" class="block text-white font-semibold">Dana Keluar</label>
          <input type="text" name="dana_keluar" class="block w-full py-2 px-4 mb-2 text-base leading-normal bg-white text-gray-800 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="{{ $stok->dana_keluar }}">
        </div>
