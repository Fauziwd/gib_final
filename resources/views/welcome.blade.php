            ...
            <form class="mt-8">
                <div class="space-x-4">
                    ...
                    @guest
                        ...
                        <a href="/calon-anggota/create" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded"
                            title="Klik untuk mendaftar sebagai anggota">Daftar Anggota</a>
                    @endguest
                </div>
            </form>
