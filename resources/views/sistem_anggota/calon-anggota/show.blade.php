...
<div class="container mx-auto sm:px-4 p-6 rounded">
    ...
    <div class="bg-white dark:bg-blue-950 rounded-lg shadow-2xl overflow-hidden">
        <table class="w-full text-left h-screen">
            <tr>
                <th class="py-2 px-4 border-b  bg-gray-500 dark:bg-blue-950 text-white">ID</th>
            ...
            <tr>
                ...
                <td class="py-2 px-4 border-b dark:bg-gray-300 dark:text-blue-900">{{ $calonAnggota->pilar_paskas }}</td>
            </tr>
            <tr>
