...
@section('content')
    <div class="container mx-auto sm:px-4 p-6 rounded">
        ...
        <div class="mt-10 mb-6">
            <a href="{{ route('verifikasi-calon-anggota.create') }}" class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Verifikasi Calon Anggota</a>
        </div>
        ...
        <div class="relative overflow-x-auto shadow-2xl sm:rounded-lg">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $verifikasi->calonAnggota->nama_lengkap }}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $verifikasi->verifikasi ? 'Terverifikasi' : 'Belum Terverifikasi' }}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $verifikasi->catatan }}</td>
                        <td class="">
                            <a href="{{ route('verifikasi-calon-anggota.show', $verifikasi->id) }}"
                                class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-teal-500 text-white hover:bg-teal-600">Detail</a>
